...
(function (root, factory) {
    ...
    return Base.extend({
        ...
        init: function masonryInit($el, opts) {
            ...
            // Re-Layout after document is ready and loaded
            $(document).ready(utils.debounce(this.quicklayout.bind(this), 100));
            $(document).load(utils.debounce(this.quicklayout.bind(this), 100));
